...
#define _HOOK_CLASS_MESSAGE_(MOD, RET, CLS, MSG, META, ...)	RET $##CLS##_##MSG(id self, SEL sel, ##__VA_ARGS__);\
                                                            RET (*_##CLS##_##MSG)(id self, SEL sel, ##__VA_ARGS__);\
                                                            __attribute__((MOD)) void _Init_##CLS##_##MSG() {_HookClassMessage(objc_get##META##Class(#CLS), #MSG, (void *)$##CLS##_##MSG, (void **)&_##CLS##_##MSG);}\
                                                            RET $##CLS##_##MSG(id self, SEL sel, ##__VA_ARGS__)
...
#define HOOK_CLASS_MESSAGE(RET, CLS, MSG, ...)			_HOOK_CLASS_MESSAGE_(constructor, RET, CLS, MSG, , ##__VA_ARGS__)
